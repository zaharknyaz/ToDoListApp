...
//1.добавить иконку (label) mark as read (unread) - показывать иконку при оттягивании вправо
//2.добавить надпись в шапке ToDo List
//3.добавить подсказку если нет элементов(потяните вниз чтобы добавить элемент)
//4.разобраться почему при оттягивании влево элемент не возвращается в начало до конца
//5.Добавить иконку и анимацию на LaunchScreen
//6.Сохранять список дел при закрытии приложения в файлах или через CoreData
//7.Сделать таймер(через сколько напоминать о текущем деле - по умолчанию каждые 30 мин), push-уведомление и звук
//8.Сделать иконку приложения
